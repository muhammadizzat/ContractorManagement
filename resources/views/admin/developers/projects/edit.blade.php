            ...
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="d-flex flex-row">
                        ...
                        <div>
                            <form action="{{ route('admin.developers.projects.delete', ['dev_id' => $project->developer_id , 'id' => $project->id]) }}" method="post">
                                @csrf
                                <input class="btn btn-sm btn-danger" type="submit" onclick="return confirm('Are you sure you want to delete this project?')" value="Delete" />
                            </form>
                        </div>
                    </div>
                </div>
    ...
    $(function() {
        function readURL(input, onLoad) {
            ...
            if (mimeType.split('/')[0] === 'image') {
                ...
                $('#project-img-tag').attr('src', "{{ asset('argon') }}/img/theme/profile-pic-placeholder.png");
            }
        }
