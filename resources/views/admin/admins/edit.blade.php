            ...
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="mb-0">{{ __('Edit Linkzzapp Admin') }}</h3>
                        </div>
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('admin.admins.edit.post', ['id' => $admin->id]) }}"
                        ...
                        <div class="pl-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input id="input-is_disabled" name="is_disabled" class="custom-control-input" type="checkbox" {{ $admin->is_disabled ? 'checked' : '' }}>
                                    <label class="custom-control-label form-control-label" for="input-is_disabled">{{ __('Disabled') }}</label>
                                </div>
                            </div>
                            <div class="text-center">
                                <button onclick="return confirm('Are you sure about editing this LinkZZapp Admin?')"
