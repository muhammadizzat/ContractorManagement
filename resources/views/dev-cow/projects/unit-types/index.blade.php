...
<script type="text/javascript">
    $(function() {
        ...
        var unitTable = $('#unit').DataTable({
            ...
            responsive: true,
            order: [[ 2, "created_at" ]],
            ajax: "{{ route('dev-cow.projects.unit-types.dt', ['proj_id' => $proj_id]) }}",
            columns: [{
                    data: null,
                    orderable: false,
                    searchable: false,
        ...
        $("div.button-section.btn-add").html('<a href="{{ route("dev-cow.projects.unit-types.add", $proj_id) }}" class="btn btn-sm btn-primary"><i class="fas fa-plus-circle fa-fw"></i></a>');
        $("div.button-section.btn-excel").html('<a href="{{ route("dev-cow.projects.unit-types.export", $proj_id) }}" class="btn btn-sm btn-primary"><i class="fas fa-file-excel"></i></a>');
