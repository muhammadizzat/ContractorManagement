                    ...
                    <div class="d-flex flex-row">
                        <div class="case-info-section flex-fill">
                            ...
                            <div class="case-info-item d-flex flex-row">
                                ...
                                <div class="info-value flex-fill">
                                    <a href="{{ route("dev-cow.projects.cases.report", ['proj_id' => $proj_id, 'id' => $case->id]) }}"
                        ...
                        <div class="case-status-section pl-3">
                            <div class="case-info-header">
                                <div class="pr-3 text-right" style="margin-bottom:20px;">
                                    <a href="{{ route('dev-cow.projects.cases.index', $proj_id) }}"
...
<script type="text/javascript">
    ...
    $(function() {   
        ...
        $('#assign-contractor-modal #submit-assign-contractor-btn').click(function(event){
            ...
            postDefectAssignedContractor(assignedContractorId, function() {
    ...
    $('#close-defect-modal').on('hidden.bs.modal', function () {
        ...
        duplicateDefectSelect.clearOptions();
    })
    ...
    function postCaseStatus(caseStatus, onSuccess) {
        var postCaseStatusRoute = "{{ route('dev-cow.projects.cases.ajax.status.post', ['project_id' => $proj_id, 'case_id' => $case->id]) }}";
        $.ajax({
    ...
    function postCaseAssignedCow(assignedCow, onSuccess){
        var postCaseAssignedCowRoute = "{{ route('dev-cow.projects.cases.ajax.assigned-cow.post', ['project_id' => $proj_id, 'case_id' => $case->id])}}"
        $.ajax({
    ...
    var postCaseTagsRouteTemplate = "{{ route('dev-cow.projects.cases.ajax.tags.post', ['proj_id' => $proj_id, 'id' => '<<id>>']) }}";
    ...
    var postDefectAssignedContractorRouteTemplate = "{{ route('dev-cow.projects.cases.defects.ajax.assigned-contractor.post', ['project_id' => $proj_id, 'case_id' => $case->id, 'id' => '<<id>>'])}}"
   function postDefectAssignedContractor(assignedContractor, onSuccess) {
    ...
    function postCaseDescription(description, onSuccess) {
        var postCaseDescriptionRoute = "{{ route('dev-cow.projects.cases.ajax.description.post', ['project_id' => $proj_id, 'case_id' => $case->id]) }}";
        $.ajax({
    ...
    var postDefectStatusRouteTemplate = "{{ route('dev-cow.projects.cases.defects.ajax.status.post', ['project_id' => $proj_id, 'case_id' => $case->id, 'id' => '<<id>>']) }}";
    ...
    var getDefectRouteTemplate = "{{ route('dev-cow.projects.cases.defects.ajax.info', ['project_id' => $proj_id, 'case_id' => $case->id, 'id' => '<<id>>']) }}";
    ...
    var postDefectTagsRouteTemplate = "{{ route('dev-cow.projects.cases.defects.ajax.tags.post', ['proj_id' => $proj_id,'case_id' => $case->id , 'id' => '<<id>>']) }}";
    ...
    var postDefectExtendDueDateRouteTemplate = "{{ route('dev-cow.projects.cases.defects.ajax.extend-due-date.post', ['project_id' => $proj_id, 'case_id' => $case->id, 'id' => '<<id>>']) }}";
    ...
    var postDeleteDefectImageRouteTemplate = "{{ route('dev-cow.projects.cases.defects.ajax.image.delete', ['project_id' => $proj_id, 'case_id' => $case->id, 'defect_id' => '<<defect_id>>', 'id' => '<<id>>']) }}";
    ...
    var postDefectDefectTypeRouteTemplate = "{{ route('dev-cow.projects.cases.defects.ajax.defect-type.post', ['project_id' => $proj_id, 'case_id' => $case->id, 'id' => '<<id>>']) }}";
    ...
    function getDefects(onSuccess) {
        var getDefectsRoute = "{{ route('dev-cow.projects.cases.defects.ajax.get', ['project_id' => $proj_id, 'case_id' => $case->id]) }}";
        $.ajax({
            url: getDefectsRoute,
            type: 'GET',
            data: {
    ...
    function getDefectAndUpdateModal(defectId, modal) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                var getDefectReportUrlRouteTemplate = "{{ route("dev-cow.projects.cases.defects.report", ['project_id' => $proj_id, 'case_id' => $case->id, 'id' => '<<id>>']) }}"
    ...
    var getDefectUrlRouteTemplate = "{{ route('dev-cow.projects.cases.view', ['project_id' => $proj_id, 'case_id' => '<<case_id>>']) }}";
    ...
    var getDefectActivitiesRouteTemplate = "{{ route('dev-cow.projects.cases.defects.ajax.activities', ['project_id' => $proj_id, 'case_id' => $case->id, 'id' => '<<id>>']) }}";
    ...
    var postDefectActivityCommentRouteTemplate = "{{ route('dev-cow.projects.cases.defects.ajax.activities.comment.post', ['project_id' => $proj_id, 'case_id' => $case->id, 'id' => '<<id>>']) }}";
    ...
    var postDefectDescriptionRouteTemplate = "{{ route('dev-cow.projects.cases.defects.ajax.description.post', ['project_id' => $proj_id, 'case_id' => $case->id, 'id' => '<<id>>']) }}";
    ...
    var postDefectPinsRouteTemplate = "{{ route('dev-cow.projects.cases.defects.ajax.pins.post', ['project_id' => $proj_id, 'case_id' => $case->id, 'id' => '<<id>>']) }}";
    ...
    var getDefectDuplicateDefectInfoRouteTemplate = "{{ route('dev-cow.projects.cases.defects.ajax.duplicate-defect-info.get', ['project_id' => $proj_id, 'case_id' => $case->id, 'id' => '<<id>>']) }}";
    ...
    var postDefectImageRouteTemplate = "{{ route('dev-cow.projects.cases.defects.ajax.images.post', ['project_id' => $proj_id, 'case_id' => $case->id, 'id' => '<<id>>']) }}";
    ...
    var postDefectRequestResponseRouteTemplate = "{{ route('dev-cow.projects.cases.defects.ajax.requests.response.post', ['project_id' => $proj_id, 'case_id' => $case->id, 'defect_id' => '<<defect_id>>', 'activity_id' => '<<activity_id>>']) }}";
    ...
    var getDefectImageRouteTemplate = "{{ route('dev-cow.projects.cases.defects.images.get', ['project_id' => $proj_id, 'case_id' => $case->id, 'defect_id' => '<<defect_id>>', 'id' => '<<id>>']) }}";
    ...
    var getDefectActivityImageRouteTemplate = "{{ route('dev-cow.projects.cases.defects.activities.images.get', ['project_id' => $proj_id, 'case_id' => $case->id, 'defect_id' => '<<defect_id>>', 'activity_id' => '<<activity_id>>', 'id' => '<<id>>']) }}";
    ...
    var getActivityUserProfileImageRouteTemplate = "{{ route('dev-cow.projects.cases.defects.activities.user-profile-images.get', ['defect_id' => '<<defect_id>>', 'activity_id' => '<<activity_id>>', 'id' => '<<id>>']) }}";
    ...
    function postDefect(title, type, dueDate, description, onSuccess, onError){
        var postDefectRoute = "{{ route('dev-cow.projects.cases.defects.ajax.post', ['project_id' => $proj_id, 'case_id' => $case->id]) }}";
        $.ajax({
            url: postDefectRoute,
            type: 'POST',
            data: {
    ...
    var getUnitTypeFloorPlanImageRouteTemplate = "{{ route('dev-cow.projects.unit-types.floors.floor-plan.get', ['proj_id' => $proj_id, 'unit_type_id' => $case->unit_id, 'id' => '<<id>>']) }}";
    ...
    var postSearchDefectsRouteTemplate = "{{ route('dev-cow.projects.defects.ajax.search.post', ['proj_id' => $proj_id, 'defect_id' => '<<defect_id>>']) }}";
    ...
    var postSearchContractorRouteTemplate = "{{ route('dev-cow.contractors.ajax.search.post') }}";
        ...
        getDefects(function(defects) {
            ...
            for(defect of defects) {
                ...
                if(defect.assigned_contractor) {
                    ...
                    var contractor_name = defect.assigned_contractor.name;
                    var contractor_email = defect.assigned_contractor.email;
                    var contractor_contact = defect.assigned_contractor.contractor.contact_no;
                    var contractor_address_1 = defect.assigned_contractor.contractor.address_1;
                    var contractor_address_2 = defect.assigned_contractor.contractor.address_2;
                    var contractor_city = defect.assigned_contractor.contractor.city;
                    var contractor_postal_code = defect.assigned_contractor.contractor.postal_code;
                    var contractor_state = defect.assigned_contractor.contractor.state;

                    var tooltipEl = newDefectEl.find('.defect-assigned-contractor .contractor-tooltip-' + defect.assigned_contractor_user_id);
                    tooltipEl.tooltip({
                        items: tooltipEl,
                        content: `<strong>Name</strong> : ${contractor_name} <br> 
                                    <strong>Email</strong> : ${contractor_email} <br>
                                    <strong>Contact</strong> : ${contractor_contact} <br>
                                    <strong>Address 1</strong> : ${contractor_address_1} <br>
                                    <strong>Address 2</strong> : ${contractor_address_2} <br>
                                    <strong>City</strong> : ${contractor_city} <br>
                                    <strong>Postal Code</strong> : ${contractor_postal_code} <br>
                                    <strong>State</strong> : ${contractor_state} <br>`
                    });
                } else {
