...
<script type="text/javascript">
    ...
    function getAssigneesDt(options, onSuccess) {
        var getAssigneesRoute = "{{ route('dev-cow.projects.assignees.dt', ['proj_id' => $proj_id ]) }}";
    ...
    var getAssigneesDefectsRouteTemplate = "{{ route('dev-cow.projects.assignees.defects.ajax.get', ['proj_id' => $proj_id, 'user_id' => '<<user_id>>']) }}";
