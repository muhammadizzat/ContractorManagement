    ...
    <div id="project-dashboard-card" class="card shadow">
        ...
        <div class="card-body p-2">
            ...
            <div class="tab-content" id="dashboard-tabs-content">
                @include('dev-cow.projects.dashboard-tabs.by-defects', ['proj_id' => $proj_id])
                @include('dev-cow.projects.dashboard-tabs.by-defect-types', ['proj_id' => $proj_id])
                {{-- @include('dev-cow.projects.dashboard-tabs.by-units', ['proj_id' => $proj_id]) --}}
                @include('dev-cow.projects.dashboard-tabs.by-tags', ['proj_id' => $proj_id])
                @include('dev-cow.projects.dashboard-tabs.by-response-times', ['proj_id' => $proj_id])
