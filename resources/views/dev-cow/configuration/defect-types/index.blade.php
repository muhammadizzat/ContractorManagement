...
<script type="text/javascript">
    $(function() {
        ...
        var defectTypeTable = $('#defect_type').DataTable({
            ...
            responsive: true,
            order: [[ 3, "dsc" ], [ 1, "asc"]],
            ajax: "{{ route('dev-cow.configuration.defect-types.dt') }}",
            columns: [{
                    data: null,
                    orderable: false,
                    searchable: false,
        ...
        $("div.button-section").html('<a href="{{ route("dev-cow.configuration.defect-types.add") }}" class="btn btn-sm btn-primary"><i class="fas fa-plus-circle fa-fw"></i></a>');
    });
