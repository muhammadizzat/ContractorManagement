            ...
            <div class="card bg-secondary shadow">
                ...
                <div class="card-body">
                    <form class="prevent-multiple-submits" method="post"
                        action="{{ route('dev-cow.configuration.defect-types.add.post') }}" autocomplete="off" novalidate>
                        @csrf
                        ...
                        <div class="pl-lg-4">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-success btn-submit mt-4">{{ __('Save') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
