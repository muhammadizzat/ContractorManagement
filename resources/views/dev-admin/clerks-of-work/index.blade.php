...
<script type="text/javascript">
    $(function() {
        ...
        var clerkOfWorkTable = $('#clerk-of-work').DataTable({
            ...
            ajax: "{{ route('dev-admin.clerks-of-work.dt')}}",           
            columns: [{
                    orderable: false,
                    searchable: false,
        ...
        $("div.button-section.btn-add").html('<a href="{{ route("dev-admin.clerks-of-work.add") }}" class="btn btn-sm btn-primary"><i class="fas fa-plus-circle fa-fw"></i></a>');
        ...
        $("div.button-section.btn-excel").html('<a href="{{ route("dev-admin.clerks-of-work.export") }}" class="btn btn-sm btn-primary"><i class="fas fa-file-excel"></i></a>');
