...
<script type="text/javascript">
    $(function() {
        ...
        var defectsTable = $('#defects').DataTable({
            ...
            processing:true,
            responsive:true,
            ajax: "{{route('dev-admin.projects.defects.dt', $proj_id) }}",
            columns: [{
                    searchable: false,
                    orderable: false,
        ...
        $("div.button-section").html('<a href="{{ route("dev-admin.projects.cases.add", $proj_id) }}" class="btn btn-sm btn-primary"><i class="fas fa-calendar fa-fw"></i></a>');
    });
