...
<script type="text/javascript">
    $(function() {
        ...
        var clerksOfWorkTable = $('#cases').DataTable({
            dom: '<"button-section">frtip',
            order: [[ 3, "created_at" ]],
            serverSide:true,
            processing:true,
            responsive:true,
            ajax: "{{route('dev-admin.projects.cases.dt', $proj_id) }}",
            columns: [{
                    searchable: false,
                    orderable: false,
        ...
        $("div.button-section").html('<a href="{{ route("dev-admin.projects.cases.add", $proj_id) }}" class="btn btn-sm btn-primary"><i class="fas fa-plus-square fa-fw"></i></a>');
    });
