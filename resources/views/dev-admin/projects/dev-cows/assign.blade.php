                ...
                <form role="form" method="post" action="{{route('dev-admin.projects.dev-cows.assign.post', $proj_id)}}" autocomplete="off">
                        ...
                        <div class="pl-lg-4">
                            ...
                            <div class="form-group{{ $errors->has('dev_cow_user_id') ? ' has-danger' : '' }}">
                                <select class="form-control selectpicker form-control-alternative{{ $errors->has('dev_cow_user_id') ? 'is-invalid' : '' }}" name="dev_cow_user_id" id="dev_cow_user_id" data-live-search="true" title="Please Choose Name" required>
