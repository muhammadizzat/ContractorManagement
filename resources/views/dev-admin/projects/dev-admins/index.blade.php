...
<script type="text/javascript">
    $(function() {
        ...
        var clerkOfWorkTable = $('#assign_dev_admin').DataTable({
            ...
            serverSide: true,
            responsive: true,
            ajax: "{{ route('dev-admin.projects.dev-admins.dt', $proj_id) }}",
            columns: [{
                    searchable: false,
                    orderable: false,
        ...
        $("div.button-section").html('<a href="{{ route("dev-admin.projects.dev-admins.assign", $proj_id) }}" class="btn btn-sm btn-primary"><i class="fas fa-link fa-fw"></i></a>');
    });
