...
<script type="text/javascript">
    $(function() {
        ...
        var unitTable = $('#unit').DataTable({
            dom: '<"button-section btn-excel"><"button-section btn-import"><"button-section btn-back-to-project"><"button-section btn-add">frtip',
            processing: true,
            serverSide: true,
            responsive: true,
            order: [[ 6, "created_at" ]],
            ajax: "{{ route('dev-admin.projects.units.dt', ['proj_id' => $proj_id]) }}",
            columns: [{
                    data: null,
                    orderable: false,
                    searchable: false,
        ...
        $('.button-section.btn-import').tooltip({
            placement: 'bottom',
        ...
        $("div.button-section.btn-add").html('<a href="{{ route("dev-admin.projects.units.add", $proj_id) }}" class="btn btn-sm btn-primary"><i class="fas fa-plus-circle fa-fw"></i></a>');
        $("div.button-section.btn-import").html('<a href="{{ route("dev-admin.projects.units.import", $proj_id) }}" class="btn btn-sm btn-primary"><i class="fas fa-upload"></i></a>');
        $("div.button-section.btn-excel").html('<a href="{{ route("dev-admin.projects.units.export", $proj_id) }}" class="btn btn-sm btn-primary"><i class="fas fa-file-excel"></i></a>');
