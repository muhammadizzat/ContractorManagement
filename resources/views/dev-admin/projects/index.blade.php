                ...
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        ...
                        <div class="text-right pr-3">
                            <a href="{{ route("dev-admin.projects.export") }}" class="btn btn-sm btn-primary"><i class="fas fa-file-excel fa-fw"></i></a>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function getProjectsDt(options, onSuccess) {
        var getProjectsRoute = "{{ route('dev-admin.projects.dt') }}";
    ...
    var getUrlForProjectImageRouteTemplate = "{{ route('dev-admin.projects.logo', ['proj_id' => '<<proj_id>>']) }}";
    var getUrlForProjectPage = "{{ route('dev-admin.projects.dashboard', ['proj_id' => '<<proj_id>>']) }}";
    var getUrlForAssignDevRouteTemplate = "{{ route('dev-admin.projects.dev-admins.index', ['proj_id' => '<<proj_id>>']) }}";
    var getUrlForAssignClerkOfWorksRouteTemplate = "{{ route('dev-admin.projects.dev-cows.index', ['proj_id' => '<<proj_id>>']) }}";
    var getUrlForCasesRouteTemplate = "{{ route('dev-admin.projects.cases.index', ['proj_id' => '<<proj_id>>']) }}";
    var getUrlForUnitTypesRouteTemplate = "{{ route('dev-admin.projects.unit-types.index', ['proj_id' => '<<proj_id>>']) }}";
    var getUrlForUnitsRouteTemplate = "{{ route('dev-admin.projects.units.index', ['proj_id' => '<<proj_id>>']) }}";
    var getUrlForCalendarRouteTemplate = "{{ route('dev-admin.projects.calendar', ['proj_id' => '<<proj_id>>']) }}";
