...
<script type="text/javascript">
    $(function() {
        ...
        var defectTypeTable = $('#defect_type').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ route('dev-admin.configuration.defect-types.dt') }}",
            columns: [{
                    data: null,
                    orderable: false,
                    searchable: false,
        ...
        $("div.button-section").html('<a href="{{ route("dev-admin.configuration.defect-types.add") }}" class="btn btn-sm btn-primary"><i class="fas fa-plus-circle fa-fw"></i></a>');
    });
