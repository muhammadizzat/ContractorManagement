...
<script type="text/javascript">
    $(function() {
        ...
        var developerContractorAssociationTable = $('#developer_contractor_association').DataTable({
            ...
            serverSide: true,
            responsive: true,
            ajax: "{{ route('dev-admin.associations.dt') }}",
            columns: [{
                    orderable: false,
                    searchable: false,
    ...
    $('.button-section.btn-add').tooltip({
        ...
        $("div.button-section.btn-add").html('<a href="{{ route("dev-admin.associations.add") }}" class="btn btn-sm btn-primary"><i class="fas fa-link fa-fw"></i></a>');
        ...
        $("div.button-section.btn-excel").html('<a href="{{ route("dev-admin.associations.export") }}" class="btn btn-sm btn-primary"><i class="fas fa-file-excel"></i></a>');
    });
