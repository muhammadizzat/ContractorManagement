...
use App\Excel\Exports\UnitTypesTemplate;
...
class UnitTypeController extends Controller
{
    ...
    {
        return view('dev-cow.projects.unit-types.index', ['proj_id' => $proj_id]);
    }
    ...
    public function getDataTableUnitTypes(Request $request, $proj_id)
    {
        ...
        return DataTables::of($unit_types)
            ...
            ->addColumn('editUrl', function ($row) {
                return route('dev-cow.projects.unit-types.edit', ['proj_id' => $row->project_id, 'id' => $row->id]);
            })
            ->addColumn('deleteUrl', function ($row) {
                return route('dev-cow.projects.unit-types.delete', ['proj_id' => $row->project_id, 'id' => $row->id]);
            })
            ->make(true);
    }
    ...
    {
        return view('dev-cow.projects.unit-types.import', ['proj_id' => $proj_id]);
    }
    ...
    public function postUnitTypesExcelImport(Request $request, $proj_id)
    {
        ...
        return redirect()->route('dev-cow.projects.unit-types.index', ['proj_id' => $proj_id])->withStatus(__('Unit Type successfully imported.'));
    }
    ...
    {
        return view('dev-cow.projects.unit-types.add', ['proj_id' => $proj_id]);
    }
    ...
    public function postAddUnitType($proj_id)
    {
        ...
        return redirect()->route('dev-cow.projects.unit-types.index', ['proj_id' => $proj_id])->withStatus(__('Unit Type successfully created.'));
    }
    ...
    public function editUnitType(Request $request, $proj_id, $id)
    {
        ...
        return view('dev-cow.projects.unit-types.edit', ['unit_type' => $unit_type, 'proj_id' => $proj_id, 'id' => $id]);
    }
    ...
    public function postEditUnitType(Request $request, $proj_id)
    {
        ...
        return redirect()->route('dev-cow.projects.unit-types.index', ['unit_types' => $unit_types, 'proj_id' => $proj_id])->withStatus(__('Unit Type is successfully updated.'));
    }
    ...
    public function deleteUnitType(Request $request, $proj_id)
    {
        ...
        if ($unit == 0) {
            ...
            // }
            return redirect()->route('dev-cow.projects.unit-types.index', ['proj_id' => $proj_id])->with('status', 'Unit Type is successfully deleted.');
        } else {
            return redirect()->route('dev-cow.projects.unit-types.index', ['proj_id' => $proj_id])->with('failed', 'Unit Type failed to delete due to existing unit(s).');
        }
    }
    ...
    public function postAddUnitTypeFloor($proj_id, $id)
    {
        ...
        $unit_type = UnitType::find($id);
        $floor = $unit_type->floors()->create($imageData);
