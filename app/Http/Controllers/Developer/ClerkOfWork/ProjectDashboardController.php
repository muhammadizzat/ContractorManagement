...
class ProjectDashboardController extends Controller
{
    ...
    {
            return view('dev-cow.projects.dashboard', ['proj_id' => $proj_id]);
    }
    ...
    const DEFECTS_CLOSED_WITHIN_DAYS_ENTRIES = [
        15
    ];
    ...
    public function ajaxDefectGetByResponseTimesStats($proj_id)
    {
        ...
        $defects_closed_within_days_stats = [];
        foreach(self::DEFECTS_CLOSED_WITHIN_DAYS_ENTRIES as $days) {
        ...
        return [
            "data" => [
                ...
                "defects_closed_within_days" => $defects_closed_within_days_stats,
