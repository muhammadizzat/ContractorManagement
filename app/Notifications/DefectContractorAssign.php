...
class DefectContractorAssign extends Notification
{
    use Queueable;
    ...
    public function toOneSignal($notifiable)
    {
        return OneSignalMessage::create()
            ->subject("Contractor Assigned to Defect")
            ->body($this->defect->assigned_contractor." has been assigned to defect (C".$this->case->ref_no."-D".$this->defect->ref_no.") as a contractor")
