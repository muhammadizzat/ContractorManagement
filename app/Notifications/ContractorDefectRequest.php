...
class ContractorDefectRequest extends Notification
{
    use Queueable;
    ...
    { 
        return OneSignalMessage::create()
            ->subject("New Defect Request")
            ->body("New defect request (C".$this->case->ref_no."-D".$this->defect->ref_no.") was created by '".$this->user_name."'")
