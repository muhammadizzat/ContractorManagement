...
class DefectImageUpdated extends Notification
{
    use Queueable;
    ...
    { 
        return OneSignalMessage::create()
            ->subject("Defect Image Updated")
            ->body("Defect (C".$this->case->ref_no."-D".$this->defect->ref_no.") image was updated by '".$this->user_name."'")
