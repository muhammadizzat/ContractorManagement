...
class NewDefectStatus extends Notification
{
    use Queueable;
     ...
     * @return void
     */
    public function __construct($project, $case, $defect, $prev_status, $defect_activity)
    {
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'previous_status' => !empty($this->previous_status)? DefectStatus::$dict[$this->previous_status] : null,
            'defect_status' => !empty($this->defect->status)? DefectStatus::$dict[$this->defect->status] : null,
    ...
    { 
        return OneSignalMessage::create()
            ...
            ->body("Status for defect (C".$this->case->ref_no."-D".$this->defect->ref_no.") is now '".DefectStatus::$dict[$this->defect->status]."'")
