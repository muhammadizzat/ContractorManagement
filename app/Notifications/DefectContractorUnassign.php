...
class DefectContractorUnassign extends Notification
{
    use Queueable;
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'assigned_contractor' => $this->defect->assigned_contractor,
    ...
    public function toOneSignal($notifiable)
    {
        return OneSignalMessage::create()
            ->subject("Contractor Unassigned from Defect")
            ->body($this->defect->assigned_contractor." has been unassigned from defect (C".$this->case->ref_no."-D".$this->defect->ref_no.") as a contractor")
